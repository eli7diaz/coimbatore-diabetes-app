                ...
                <div className="text-center space-y-6 py-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium text-muted-foreground px-4">
                            Based on your answers, this preliminary self-assessment suggests registering as:
                        </p>
                    </div>
                    ...
                    <p className="text-[11px] font-medium text-muted-foreground px-6 leading-relaxed">
                        This result is generated by a simple client-side questionnaire, not a clinical diagnosis. Your assigned provider will verify and confirm your diabetes type during onboarding.
                    </p>
