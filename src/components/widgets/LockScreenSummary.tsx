            ...
            <div className="bg-black/80 backdrop-blur-xl rounded-[2.5rem] p-6 border border-white/10 shadow-2xl text-white">
                <div className="flex justify-between items-start mb-8">
                    <div className="flex flex-col">
                        <span className="text-xs font-semibold text-white/60">NEXT CHECK</span>
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-[10px] font-bold text-glucose-normal shrink-0">STABLE</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-white/5 rounded-2xl p-4 border border-white/5">
                        <div className="flex items-center gap-2 mb-1 opacity-60">
                            <Clock size={14} />
                            <span className="text-[10px] font-bold uppercase tracking-widest">Insulin</span>
                        </div>
